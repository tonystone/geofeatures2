...
class PointGeometryCoordinate2DFloatingPrecisionCartesianTests: XCTestCase {
    ...
    func testCrossesFalse() {
        ...
        XCTAssertFalse(testPoint.crosses(lineString1))
        XCTAssertFalse(testPoint.crosses(lineString2))
        XCTAssertFalse(testPoint.crosses(linearRing1))
        XCTAssertFalse(testPoint.crosses(linearRing2))
        XCTAssertFalse(testPoint.crosses(multiLineString1))
        XCTAssertFalse(testPoint.crosses(multiLineString2))

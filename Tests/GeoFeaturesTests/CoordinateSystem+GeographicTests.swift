...
class CoordinateSystemGeographicTests: XCTestCase {
    ...
    func testEqualTrue() {
        XCTAssertTrue(Geographic() == Geographic())
    }

    func testEqualFalse() {
        XCTAssertFalse(Geographic() == DummyCoordinateReferenceSystem())
    }

    func testDescription() {
        XCTAssertEqual(Geographic().description, "Geographic()")
    }

    func testDebugDescription() {
        XCTAssertEqual(Geographic().debugDescription, "Geographic()")
    }
}

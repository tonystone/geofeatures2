...
extension AVLTreeTests {
   ...
   static var allTests: [(String, (AVLTreeTests) -> () throws -> Void)] {
      return [
                ...
                ("testRemoveRoot3NodeTree", testRemoveRoot3NodeTree),
                ("testRemoveExisting1", testRemoveExisting1),
                ("testRemoveExisting5", testRemoveExisting5),
                ("testRemoveExisting7", testRemoveExisting7),
                ("testRemoveExisting8", testRemoveExisting8),
                ("testRemoveExisting10", testRemoveExisting10),
                ("testRemoveExistingLeafNodesForceReBalance", testRemoveExistingLeafNodesForceReBalance),
                ("testRemoveExistingLeafNodesNoReBalance", testRemoveExistingLeafNodesNoReBalance),
                ("testRemoveExistingInnerNodes", testRemoveExistingInnerNodes),
                ("testRemoveExistingAllBut3", testRemoveExistingAllBut3),
                ("testRemoveExistingAllBut1", testRemoveExistingAllBut1),
                ("testRemoveExistingAll", testRemoveExistingAll),

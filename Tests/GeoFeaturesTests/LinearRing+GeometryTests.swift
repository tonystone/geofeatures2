...
class LinearRingGeometryCoordinate2DFloatingPrecisionCartesianTests: XCTestCase {
    ...
    func testBoundaryWith1ElementInvalid() {
        let input = LinearRing(coordinates: [[1.0, 1.0]], precision: precision, coordinateSystem: cs).boundary()
    ...
    func testBoundaryWith2Element() {
        let input = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0]], precision: precision, coordinateSystem: cs).boundary()
    ...
    func testBoundaryWith3ElementOpen() {
        let input = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0], [3.0, 3.0]], precision: precision, coordinateSystem: cs).boundary()
    ...
    func testBoundaryWith4ElementClosed() {
        let input = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0], [3.0, 3.0], [1.0, 1.0]], precision: precision, coordinateSystem: cs).boundary()
        let expected = MultiPoint(precision: precision, coordinateSystem: cs) // Empty Set
    ...
    func testBoundsWithElements() {
        let input = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0], [3.0, 3.0], [1.0, 1.0]], precision: precision, coordinateSystem: cs)
    ...
    func testEqualTrue() {
        let input1 = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0]], precision: precision, coordinateSystem: cs)
        let input2 = LinearRing(coordinates: [[1.0, 1.0], [2.0, 2.0]], precision: precision, coordinateSystem: cs)

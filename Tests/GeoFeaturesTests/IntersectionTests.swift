...
class IntersectionTests: XCTestCase {
    ...
    ///
    /// Point GeometryCollection tests
    ///

    func testPointGeometryCollection_emptyGeometryCollection_noIntersection() {
    ...
    func testPointGeometryCollection_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 1.0, y: 1.0)), Point(Coordinate(x: 2.0, y: 2.0))])])
    ...
    func testPointGeometryCollection_geometryCollectionWithLineString_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 3.0, y: 1.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: 5.0), Coordinate(x: 5.0, y: 1.0), Coordinate(x: 1.0, y: 1.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 2.0)]), LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0)])])])
    ...
    func testPointGeometryCollection_geometryCollectionWithPolygon_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
    ...
    func testPointGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([Point(Coordinate(x: 0.0, y: 0.0))])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 1.0, y: 1.0))])])
    ...
    func testPointGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 1.0, y: 1.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])])
    ...
    func testPointGeometryCollection_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: -1.0, y: 1.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: -1.0), Coordinate(x: -1.0, y: -1.0), Coordinate(x: -1.0, y: 1.0)])])
    ...
    func testPointGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -1.0, y: 1.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: -1.0), Coordinate(x: -1.0, y: -1.0), Coordinate(x: -1.0, y: 1.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
    ...
    func testMultiPointGeometryCollection_emptyGeometryCollection_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 10.0, y: -18.0))]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPointGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 1.0)])])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
    ...
    func testMultiPointGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {
    ...
    func testLineString_MultiPolygon_boundaryIntersectsInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
    ...
    ///
    /// LineString GeometryCollection tests
    ///

    func testLineStringGeometryCollection_emptyGeometryCollection_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testLineStringGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 2.5, y: 20.0), Coordinate(x: 2.5, y: -20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -7.0, y: 10.0)])
        let geometry2 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
    ...
    func testLineStringGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 10.0, y: -20.0), Coordinate(x: -34.0, y: -20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)])
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
    ...
    func testLineStringGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 3.0, y: 20.0), Coordinate(x: 3.0, y: -20.0), Coordinate(x: -34.0, y: -20.0), Coordinate(x: -7.0, y: 10.0)])
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLineStringGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 1.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLineStringGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 10.0, y: 0.0), Coordinate(x: -2.0, y: 0.0), Coordinate(x: 0.0, y: -9.0), Coordinate(x: 4.0, y: -13.0)])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 2.0, y: -11.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLineStringGeometryCollection_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: 0.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: -20.0), Coordinate(x: -20.0, y: -20.0), Coordinate(x: -20.0, y: 0.0), Coordinate(x: -40.0, y: 0.0)])
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 0.0, y: 3.0), Coordinate(x: 0.0, y: -3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLineStringGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: 0.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: -20.0), Coordinate(x: -6.0, y: -20.0), Coordinate(x: -6.0, y: 20.0), Coordinate(x: -40.0, y: 20.0)])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -6.0, y: 2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 0.0, y: 3.0), Coordinate(x: 0.0, y: -3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLineStringGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {

        let geometry1 = LineString([Coordinate(x: 20.0, y: -18.0), Coordinate(x: 0.0, y: -18.0), Coordinate(x: -4.0, y: 0.0), Coordinate(x: -4.0, y: 20.0), Coordinate(x: -6.0, y: 20.0), Coordinate(x: -40.0, y: 20.0)])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)]), LineString([Coordinate(x: -4.0, y: 4.0), Coordinate(x: -4.0, y: 2.0)])]))
    ...
    ///
    /// LinearRing GeometryCollection tests
    ///

    func testLinearRingGeometryCollection_emptyGeometryCollection_noIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 19.0, y: -1.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection()
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: 8.0, y: 9.0), Coordinate(x: 21.0, y: 0.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 2.5), Coordinate(x: 0.0, y: 2.5), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -9.0), Coordinate(x: 21.0, y: -9.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 2.5), Coordinate(x: 0.0, y: 2.5), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -18.0), Coordinate(x: 21.0, y: -18.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 0.0), Coordinate(x: 3.0, y: 0.0), Coordinate(x: 3.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -18.0), Coordinate(x: 21.0, y: -18.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 1.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 0.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -11.0), Coordinate(x: 21.0, y: -11.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 1.0, y: 1.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLinearRingGeometryCollection_geometryCollectionWithPolygon_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: 1.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 0.0, y: 3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testLinearRingGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 1.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 0.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -6.0, y: 9.0), Coordinate(x: -6.0, y: -11.0), Coordinate(x: 21.0, y: -11.0), Coordinate(x: 21.0, y: -3.0)])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
    ...
    func testLinearRingGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: -6.0, y: 2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0)])]))
...
//        compareTopo(resultGeometry, expected, "Coordinate(x: 1.5, y: -2.5)")
    ...
    func testMultiLineStringGeometryCollection_emptyGeometryCollection_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = MultiLineString([LineString([Coordinate(x: -20.0, y: 4.0), Coordinate(x: -40.0, y: 4.0), Coordinate(x: -40.0, y: -50.0), Coordinate(x: 6.0, y: -50.0), Coordinate(x: 6.0, y: -20.0)]), LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 2.5), Coordinate(x: 0.0, y: 2.5), Coordinate(x: 0.0, y: 4.0), Coordinate(x: -8.0, y: 4.0), Coordinate(x: -8.0, y: -2.0), Coordinate(x: -6.0, y: -2.0)])])
        let geometry2 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = MultiLineString([LineString([Coordinate(x: -20.0, y: 4.0), Coordinate(x: -40.0, y: 4.0), Coordinate(x: -40.0, y: -50.0), Coordinate(x: 6.0, y: -50.0), Coordinate(x: 6.0, y: -20.0)]), LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 3.0, y: 0.0), Coordinate(x: 3.0, y: 6.0), Coordinate(x: -8.0, y: 6.0), Coordinate(x: -8.0, y: -4.0), Coordinate(x: 0.0, y: -2.0), Coordinate(x: 0.0, y: -4.0)])])
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithPolygon_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -3.0), Coordinate(x: 0.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiLineStringGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {
    ...
    func testMultiLineStringGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {
    ...
    func testPolygon_LinearRing_interiorsExteriorsIntersect1() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 7.0, y: -1.0), Coordinate(x: 8.0, y: -1.0), Coordinate(x: 8.0, y: -4.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_LinearRing_interiorsExteriorsIntersect2() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 7.0, y: -7.0), Coordinate(x: 12.0, y: -7.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_LinearRing_intersectsPolygonBoundaryInteriorExterior() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 10.0), Coordinate(x: 4.0, y: 10.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_Polygon_secondInsideFirst() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 7.0, y: -1.0), Coordinate(x: 8.0, y: -1.0), Coordinate(x: 4.0, y: -4.0)])]))
    ...
    func testPolygon_Polygon_firstInsideSecond() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 0.0, y: 0.0), Coordinate(x: 10.0, y: 0.0), Coordinate(x: 10.0, y: -10.0), Coordinate(x: 0.0, y: -10.0), Coordinate(x: 0.0, y: 0.0)])]))
    ...
    func testPolygon_Polygon_interiorsExteriorsIntersect1() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 7.0, y: -1.0), Coordinate(x: 10.0, y: -4.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 5.5, y: -2.5), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -4.0), Coordinate(x: 5.5, y: -2.5), ])]))
    ...
    func testPolygon_Polygon_interiorsExteriorsIntersect2() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 12.0, y: -4.0), Coordinate(x: 7.0, y: -7.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 7.0, y: -4.0), Coordinate(x: 5.5, y: -5.5), Coordinate(x: 4.0, y: -4.0), Coordinate(x: 7.0, y: -4.0), ])]))
    ...
    func testPolygon_Polygon_intersectsBoundaryInteriorExterior() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 4.0, y: -4.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 10.0), Coordinate(x: 4.0, y: 10.0), Coordinate(x: 4.0, y: -4.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 2.5, y: -2.5), Coordinate(x: 4.0, y: -1.0), Coordinate(x: 4.0, y: -4.0), Coordinate(x: 2.5, y: -2.5), ])]))
    ...
    func testPolygon_Polygon_intersectsBoundaryInteriorAndExteriorInsideHole() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -8.0, y: -8.0), Coordinate(x: -7.0, y: -8.0), Coordinate(x: -7.0, y: -9.0), Coordinate(x: -9.0, y: -9.0), Coordinate(x: -8.0, y: -8.0)])]))
    ...
    func testPolygon_Polygon_intersectsBoundaryInteriorExterior_multipleTimes() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: -4.0, y: -6.0), Coordinate(x: -4.0, y: 5.0), Coordinate(x: 12.0, y: 5.0), Coordinate(x: 12.0, y: -3.0), Coordinate(x: 0.0, y: -3.0), Coordinate(x: 0.0, y: -4.0), Coordinate(x: 10.0, y: -4.0), Coordinate(x: 10.0, y: -6.0), Coordinate(x: -4.0, y: -6.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 7.0, y: -4.0), Coordinate(x: 5.0, y: -6.0), Coordinate(x: 3.0, y: -6.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 7.0, y: -4.0)]), Polygon([Coordinate(x: 2.0, y: -3.0), Coordinate(x: 4.0, y: -1.0), Coordinate(x: 6.0, y: -3.0), Coordinate(x: 2.0, y: -3.0)])]))
    ...
    func testPolygon_Polygon_intersectsBoundaryInteriorAndExterior_bothInsideAndOutsideHole() {
        ...
        let geometry1 = Polygon([Coordinate(x: -10.0, y: -2.0), Coordinate(x: -2.0, y: -2.0), Coordinate(x: -2.0, y: -10.0), Coordinate(x: -10.0, y: -10.0), Coordinate(x: -10.0, y: -2.0)], innerRings: [[Coordinate(x: -8.0, y: -4.0), Coordinate(x: -8.0, y: -8.0), Coordinate(x: -4.0, y: -8.0), Coordinate(x: -4.0, y: -4.0), Coordinate(x: -8.0, y: -4.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: -7.0, y: -7.0), Coordinate(x: -6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: -14.0), Coordinate(x: -7.0, y: -7.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -6.0, y: -8.0), Coordinate(x: -4.0, y: -8.0), Coordinate(x: -4.0, y: -6.0), Coordinate(x: -2.0, y: -6.0), Coordinate(x: -2.0, y: -10.0), Coordinate(x: -4.0, y: -10.0), Coordinate(x: -6.0, y: -8.0)])]))
    ...
    func testPolygon_Polygon_identicalPolygons() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 4.0, y: -1.0), Coordinate(x: 7.0, y: -4.0), Coordinate(x: 4.0, y: -7.0), Coordinate(x: 1.0, y: -4.0), Coordinate(x: 4.0, y: -1.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_Polygon_withHoles_firstSameAsSecondButWithOneExtraHole() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -2.0, y: -2.0), Coordinate(x: -2.0, y: -10.0), Coordinate(x: -10.0, y: -10.0), Coordinate(x: -10.0, y: -2.0), Coordinate(x: -2.0, y: -2.0)], innerRings: [[Coordinate(x: -8.0, y: -8.0), Coordinate(x: -7.0, y: -8.0), Coordinate(x: -7.0, y: -7.0), Coordinate(x: -8.0, y: -7.0), Coordinate(x: -8.0, y: -8.0)], [Coordinate(x: -6.0, y: -5.0), Coordinate(x: -6.0, y: -6.0), Coordinate(x: -5.0, y: -6.0), Coordinate(x: -5.0, y: -5.0), Coordinate(x: -6.0, y: -5.0)]], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_Polygon_withHoles_overlap_multipleHoles_insideOutsideMiddle1() {

        let geometry1 = Polygon([Coordinate(x: 40.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 40.0, y: 0.0)], innerRings: [[Coordinate(x: 4.0, y: 4.0), Coordinate(x: 8.0, y: 4.0), Coordinate(x: 8.0, y: 6.0), Coordinate(x: 4.0, y: 6.0), Coordinate(x: 4.0, y: 4.0)], [Coordinate(x: 24.0, y: 28.0), Coordinate(x: 24.0, y: 24.0), Coordinate(x: 28.0, y: 24.0), Coordinate(x: 28.0, y: 28.0), Coordinate(x: 24.0, y: 28.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 30.0), Coordinate(x: 80.0, y: 30.0), Coordinate(x: 80.0, y: 10.0), Coordinate(x: 20.0, y: 10.0)], innerRings: [[Coordinate(x: 24.0, y: 12.0), Coordinate(x: 28.0, y: 12.0), Coordinate(x: 28.0, y: 18.0), Coordinate(x: 24.0, y: 18.0), Coordinate(x: 24.0, y: 12.0)], [Coordinate(x: 36.0, y: 20.0), Coordinate(x: 36.0, y: 16.0), Coordinate(x: 44.0, y: 16.0), Coordinate(x: 44.0, y: 20.0), Coordinate(x: 36.0, y: 20.0)], [Coordinate(x: 74.0, y: 20.0), Coordinate(x: 78.0, y: 20.0), Coordinate(x: 78.0, y: 24.0), Coordinate(x: 74.0, y: 24.0), Coordinate(x: 74.0, y: 20.0)]], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_Polygon_withHoles_overlap_multipleHoles_insideOutsideMiddle2() {

        let geometry1 = Polygon([Coordinate(x: 40.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 40.0, y: 0.0)], innerRings: [[Coordinate(x: 4.0, y: 4.0), Coordinate(x: 8.0, y: 4.0), Coordinate(x: 8.0, y: 6.0), Coordinate(x: 4.0, y: 6.0), Coordinate(x: 4.0, y: 4.0)], [Coordinate(x: 20.0, y: 30.0), Coordinate(x: 20.0, y: 24.0), Coordinate(x: 26.0, y: 24.0), Coordinate(x: 26.0, y: 30.0), Coordinate(x: 20.0, y: 30.0)], [Coordinate(x: 30.0, y: 10.0), Coordinate(x: 34.0, y: 10.0), Coordinate(x: 34.0, y: 14.0), Coordinate(x: 30.0, y: 14.0), Coordinate(x: 30.0, y: 10.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 30.0), Coordinate(x: 80.0, y: 30.0), Coordinate(x: 80.0, y: 10.0), Coordinate(x: 20.0, y: 10.0)], innerRings: [[Coordinate(x: 24.0, y: 12.0), Coordinate(x: 28.0, y: 12.0), Coordinate(x: 28.0, y: 18.0), Coordinate(x: 24.0, y: 18.0), Coordinate(x: 24.0, y: 12.0)], [Coordinate(x: 36.0, y: 20.0), Coordinate(x: 36.0, y: 16.0), Coordinate(x: 44.0, y: 16.0), Coordinate(x: 44.0, y: 20.0), Coordinate(x: 36.0, y: 20.0)], [Coordinate(x: 74.0, y: 20.0), Coordinate(x: 78.0, y: 20.0), Coordinate(x: 78.0, y: 24.0), Coordinate(x: 74.0, y: 24.0), Coordinate(x: 74.0, y: 20.0)]], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_Polygon_withHoles_overlap_multipleHoles_insideOutsideMiddle3() {

        let geometry1 = Polygon([Coordinate(x: 40.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 40.0, y: 0.0)], innerRings: [[Coordinate(x: 4.0, y: 4.0), Coordinate(x: 8.0, y: 4.0), Coordinate(x: 8.0, y: 6.0), Coordinate(x: 4.0, y: 6.0), Coordinate(x: 4.0, y: 4.0)], [Coordinate(x: 20.0, y: 20.0), Coordinate(x: 20.0, y: 10.0), Coordinate(x: 10.0, y: 10.0), Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 20.0)], [Coordinate(x: 15.0, y: 25.0), Coordinate(x: 25.0, y: 25.0), Coordinate(x: 25.0, y: 35.0), Coordinate(x: 15.0, y: 35.0), Coordinate(x: 15.0, y: 25.0)], [Coordinate(x: 30.0, y: 35.0), Coordinate(x: 30.0, y: 30.0), Coordinate(x: 35.0, y: 30.0), Coordinate(x: 35.0, y: 35.0), Coordinate(x: 30.0, y: 35.0)], [Coordinate(x: 30.0, y: 15.0), Coordinate(x: 35.0, y: 15.0), Coordinate(x: 35.0, y: 20.0), Coordinate(x: 30.0, y: 20.0), Coordinate(x: 30.0, y: 15.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 30.0), Coordinate(x: 80.0, y: 30.0), Coordinate(x: 80.0, y: 10.0), Coordinate(x: 20.0, y: 10.0)], innerRings: [[Coordinate(x: 74.0, y: 20.0), Coordinate(x: 78.0, y: 20.0), Coordinate(x: 78.0, y: 24.0), Coordinate(x: 74.0, y: 24.0), Coordinate(x: 74.0, y: 20.0)]], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 20.0, y: 25.0), Coordinate(x: 25.0, y: 25.0), Coordinate(x: 25.0, y: 30.0), Coordinate(x: 40.0, y: 30.0), Coordinate(x: 40.0, y: 10.0), Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 25.0)], innerRings: [[Coordinate(x: 30.0, y: 15.0), Coordinate(x: 35.0, y: 15.0), Coordinate(x: 35.0, y: 20.0), Coordinate(x: 30.0, y: 20.0), Coordinate(x: 30.0, y: 15.0)]], precision: precision, coordinateSystem: cs)]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygon_Polygon_withHoles_overlapOnTwoPolygons() {

        let geometry1 = Polygon([Coordinate(x: 40.0, y: 40.0), Coordinate(x: 60.0, y: 40.0), Coordinate(x: 60.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 40.0), Coordinate(x: 20.0, y: 40.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 40.0, y: 40.0)], innerRings: [[Coordinate(x: 46.0, y: 30.0), Coordinate(x: 54.0, y: 30.0), Coordinate(x: 54.0, y: 35.0), Coordinate(x: 46.0, y: 35.0), Coordinate(x: 46.0, y: 30.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: 60.0), Coordinate(x: 60.0, y: 60.0), Coordinate(x: 60.0, y: 20.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 20.0, y: 40.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 0.0, y: 20.0)], innerRings: [[Coordinate(x: 6.0, y: 35.0), Coordinate(x: 6.0, y: 30.0), Coordinate(x: 14.0, y: 30.0), Coordinate(x: 14.0, y: 35.0), Coordinate(x: 6.0, y: 35.0)]], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 40.0, y: 40.0), Coordinate(x: 60.0, y: 40.0), Coordinate(x: 60.0, y: 20.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 40.0, y: 40.0)], innerRings: [[Coordinate(x: 46.0, y: 30.0), Coordinate(x: 54.0, y: 30.0), Coordinate(x: 54.0, y: 35.0), Coordinate(x: 46.0, y: 35.0), Coordinate(x: 46.0, y: 30.0)]]), Polygon([Coordinate(x: 0.0, y: 40.0), Coordinate(x: 20.0, y: 40.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: 40.0)], innerRings: [[Coordinate(x: 6.0, y: 35.0), Coordinate(x: 6.0, y: 30.0), Coordinate(x: 14.0, y: 30.0), Coordinate(x: 14.0, y: 35.0), Coordinate(x: 6.0, y: 35.0)]])], precision: precision, coordinateSystem: cs))
...
//        expected.append(MultiPolygon([Polygon([Coordinate(x: 60.0, y: 60.0), Coordinate(x: 60.0, y: 20.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 20.0, y: 60.0), Coordinate(x: 60.0, y: 60.0)], innerRings: [[Coordinate(x: 30.0, y: 30.0), Coordinate(x: 30.0, y: 55.0), Coordinate(x: 50.0, y: 55.0), Coordinate(x: 50.0, y: 45.0), Coordinate(x: 40.0, y: 45.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 50.0, y: 40.0), Coordinate(x: 50.0, y: 30.0), Coordinate(x: 30.0, y: 30.0)]])], precision: precision, coordinateSystem: cs))
    ...
    func testPolygon_Polygon_twoSimilarPolygonsOneRotated_overlappingHoles() {

        let geometry1 = Polygon([Coordinate(x: 40.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 40.0, y: 0.0)], innerRings: [[Coordinate(x: 10.0, y: 20.0), Coordinate(x: 25.0, y: 20.0), Coordinate(x: 25.0, y: 30.0), Coordinate(x: 10.0, y: 30.0), Coordinate(x: 10.0, y: 20.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 50.0, y: 20.0), Coordinate(x: 20.0, y: -10.0), Coordinate(x: -10.0, y: 20.0), Coordinate(x: 20.0, y: 50.0), Coordinate(x: 50.0, y: 20.0)], innerRings: [[Coordinate(x: 30.0, y: 20.0), Coordinate(x: 30.0, y: 30.0), Coordinate(x: 15.0, y: 30.0), Coordinate(x: 15.0, y: 20.0), Coordinate(x: 30.0, y: 20.0)]], precision: precision, coordinateSystem: cs)
    ...
    func testPolygon_Polygon_intersectAtLineStringPolygon_overlappingHoles() {

        let geometry1 = Polygon([Coordinate(x: 80.0, y: 100.0), Coordinate(x: 80.0, y: 80.0), Coordinate(x: 60.0, y: 80.0), Coordinate(x: 60.0, y: 60.0), Coordinate(x: 80.0, y: 60.0), Coordinate(x: 80.0, y: 20.0), Coordinate(x: 60.0, y: 20.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 20.0, y: 60.0), Coordinate(x: 60.0, y: 100.0), Coordinate(x: 80.0, y: 100.0)], innerRings: [[Coordinate(x: 40.0, y: 50.0), Coordinate(x: 50.0, y: 50.0), Coordinate(x: 50.0, y: 60.0), Coordinate(x: 40.0, y: 60.0), Coordinate(x: 40.0, y: 50.0)], [Coordinate(x: 70.0, y: 30.0), Coordinate(x: 70.0, y: 50.0), Coordinate(x: 60.0, y: 50.0), Coordinate(x: 60.0, y: 30.0), Coordinate(x: 70.0, y: 30.0)]], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 0.0, y: 20.0), Coordinate(x: 20.0, y: 40.0), Coordinate(x: 0.0, y: 60.0), Coordinate(x: 0.0, y: 80.0), Coordinate(x: 40.0, y: 80.0), Coordinate(x: 40.0, y: 100.0), Coordinate(x: 100.0, y: 100.0), Coordinate(x: 100.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 0.0, y: 20.0)], innerRings: [[Coordinate(x: 30.0, y: 60.0), Coordinate(x: 30.0, y: 70.0), Coordinate(x: 20.0, y: 60.0), Coordinate(x: 30.0, y: 60.0)], [Coordinate(x: 50.0, y: 60.0), Coordinate(x: 50.0, y: 70.0), Coordinate(x: 40.0, y: 70.0), Coordinate(x: 40.0, y: 60.0), Coordinate(x: 50.0, y: 60.0)], [Coordinate(x: 40.0, y: 45.0), Coordinate(x: 70.0, y: 45.0), Coordinate(x: 70.0, y: 50.0), Coordinate(x: 40.0, y: 50.0), Coordinate(x: 40.0, y: 45.0)], [Coordinate(x: 70.0, y: 90.0), Coordinate(x: 70.0, y: 70.0), Coordinate(x: 90.0, y: 70.0), Coordinate(x: 90.0, y: 90.0), Coordinate(x: 70.0, y: 90.0)]], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 30.0, y: 70.0), Coordinate(x: 20.0, y: 60.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 80.0, y: 90.0), Coordinate(x: 70.0, y: 90.0), Coordinate(x: 70.0, y: 80.0), Coordinate(x: 60.0, y: 80.0), Coordinate(x: 60.0, y: 60.0), Coordinate(x: 80.0, y: 60.0), Coordinate(x: 80.0, y: 40.0), Coordinate(x: 70.0, y: 40.0), Coordinate(x: 70.0, y: 50.0), Coordinate(x: 50.0, y: 50.0), Coordinate(x: 50.0, y: 70.0), Coordinate(x: 40.0, y: 70.0), Coordinate(x: 40.0, y: 45.0), Coordinate(x: 60.0, y: 45.0), Coordinate(x: 60.0, y: 40.0), Coordinate(x: 40.0, y: 40.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 20.0, y: 60.0), Coordinate(x: 30.0, y: 60.0), Coordinate(x: 30.0, y: 70.0), Coordinate(x: 60.0, y: 100.0), Coordinate(x: 80.0, y: 100.0), Coordinate(x: 80.0, y: 90.0)], precision: precision, coordinateSystem: cs)]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygon_Polygon_intersectLineStringPolygons_noHoles() {

        let geometry1 = Polygon([Coordinate(x: 0.0, y: 60.0), Coordinate(x: 40.0, y: 100.0), Coordinate(x: 40.0, y: 60.0), Coordinate(x: 60.0, y: 60.0), Coordinate(x: 60.0, y: 80.0), Coordinate(x: 100.0, y: 40.0), Coordinate(x: 60.0, y: 0.0), Coordinate(x: 40.0, y: 0.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 0.0, y: 60.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 100.0, y: 10.0), Coordinate(x: 30.0, y: 10.0), Coordinate(x: 30.0, y: 0.0), Coordinate(x: 20.0, y: 0.0), Coordinate(x: 20.0, y: 80.0), Coordinate(x: 80.0, y: 80.0), Coordinate(x: 60.0, y: 100.0), Coordinate(x: 100.0, y: 100.0), Coordinate(x: 100.0, y: 60.0), Coordinate(x: 50.0, y: 60.0), Coordinate(x: 100.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 60.0, y: 60.0), Coordinate(x: 50.0, y: 60.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 40.0, y: 80.0), Coordinate(x: 40.0, y: 60.0), Coordinate(x: 50.0, y: 60.0), Coordinate(x: 85.0, y: 25.0), Coordinate(x: 70.0, y: 10.0), Coordinate(x: 30.0, y: 10.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 40.0, y: 20.0), Coordinate(x: 20.0, y: 40.0), Coordinate(x: 20.0, y: 80.0), Coordinate(x: 40.0, y: 80.0)]), Polygon([Coordinate(x: 60.0, y: 60.0), Coordinate(x: 60.0, y: 80.0), Coordinate(x: 80.0, y: 60.0), Coordinate(x: 60.0, y: 60.0)])]))
    ...
    func testPolygon_MultiPolygon_interiorsIntersect_firstPolygon() {
        ...
        let geometry1 = Polygon([Coordinate(x: 4.0, y: 0.0), Coordinate(x: 0.0, y: 4.0), Coordinate(x: 4.0, y: 8.0), Coordinate(x: 8.0, y: 4.0), Coordinate(x: 4.0, y: 0.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: 10.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: 10.0, y: 13.0), Coordinate(x: 10.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 0.0, y: 4.0), Coordinate(x: 4.0, y: 8.0), Coordinate(x: 8.0, y: 4.0), Coordinate(x: 7.0, y: 3.0), Coordinate(x: 1.0, y: 3.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_MultiPolygon_interiorsIntersect_firstPolygon_withHole() {
        ...
        let geometry1 = Polygon([Coordinate(x: -10.0, y: 10.0), Coordinate(x: -10.0, y: 12.0), Coordinate(x: -5.0, y: 12.0), Coordinate(x: -5.0, y: 10.0), Coordinate(x: -10.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -8.0, y: 10.0), Coordinate(x: -8.0, y: 12.0), Coordinate(x: -5.0, y: 12.0), Coordinate(x: -5.0, y: 10.0), Coordinate(x: -8.0, y: 10.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_MultiPolygon_interiorsIntersect_secondPolygon() {
        ...
        let geometry1 = Polygon([Coordinate(x: 0.0, y: 6.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 0.0, y: 6.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 6.0, y: -2.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 6.0, y: -2.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_MultiPolygon_interiorsIntersect_secondPolygon_withHole() {
        ...
        let geometry1 = Polygon([Coordinate(x: 15.0, y: -15.0), Coordinate(x: 15.0, y: -25.0), Coordinate(x: 5.0, y: -25.0), Coordinate(x: 15.0, y: -15.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 14.0, y: -16.0), Coordinate(x: 15.0, y: -16.0), Coordinate(x: 15.0, y: -20.0), Coordinate(x: 10.0, y: -20.0), Coordinate(x: 14.0, y: -16.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testPolygon_MultiPolygon_interiorsIntersect_bothPolygons_withHoles() {
        ...
        let geometry1 = Polygon([Coordinate(x: -18.0, y: 13.0), Coordinate(x: 18.0, y: 13.0), Coordinate(x: 18.0, y: 7.0), Coordinate(x: -18.0, y: 7.0), Coordinate(x: -18.0, y: 13.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -20.0, y: 0.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: -20.0, y: 0.0)], innerRings: [[Coordinate(x: -15.0, y: 5.0), Coordinate(x: -5.0, y: 5.0), Coordinate(x: -5.0, y: 15.0), Coordinate(x: -15.0, y: 15.0), Coordinate(x: -15.0, y: 5.0)]]), Polygon([Coordinate(x: 5.0, y: 20.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 20.0, y: 0.0), Coordinate(x: 5.0, y: 0.0), Coordinate(x: 5.0, y: 20.0)], innerRings: [[Coordinate(x: 10.0, y: 5.0), Coordinate(x: 15.0, y: 5.0), Coordinate(x: 15.0, y: 15.0), Coordinate(x: 10.0, y: 15.0), Coordinate(x: 10.0, y: 5.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -5.0, y: 7.0), Coordinate(x: -5.0, y: 13.0), Coordinate(x: 0.0, y: 13.0), Coordinate(x: 0.0, y: 7.0), Coordinate(x: -5.0, y: 7.0)]), Polygon([Coordinate(x: -15.0, y: 13.0), Coordinate(x: -15.0, y: 7.0), Coordinate(x: -18.0, y: 7.0), Coordinate(x: -18.0, y: 13.0), Coordinate(x: -15.0, y: 13.0)]), Polygon([Coordinate(x: 15.0, y: 7.0), Coordinate(x: 15.0, y: 13.0), Coordinate(x: 18.0, y: 13.0), Coordinate(x: 18.0, y: 7.0), Coordinate(x: 15.0, y: 7.0)]), Polygon([Coordinate(x: 10.0, y: 13.0), Coordinate(x: 10.0, y: 7.0), Coordinate(x: 5.0, y: 7.0), Coordinate(x: 5.0, y: 13.0), Coordinate(x: 10.0, y: 13.0)])]))
    ...
    func testPolygon_MultiPolygon_polygonIntersectsMultiPolygonInteriorAndBoundary_bothPolygons_atTwoPolygons_secondWithHole() {

        let geometry1 = Polygon([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: -20.0), Coordinate(x: -12.0, y: -20.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 21.0, y: -3.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -12.0, y: 9.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 12.0), Coordinate(x: -20.0, y: 12.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -12.0, y: 3.0), Coordinate(x: -12.0, y: 9.0)]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])]))
    ...
    func testPolygon_MultiPolygon_polygonIntersectsMultiPolygonInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = Polygon([Coordinate(x: 15.0, y: -15.0), Coordinate(x: -17.0, y: -15.0), Coordinate(x: -17.0, y: 0.0), Coordinate(x: -37.0, y: 20.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -20.0, y: 9.0), Coordinate(x: 15.0, y: 9.0), Coordinate(x: 15.0, y: -15.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -20.0, y: 20.0), Coordinate(x: -20.0, y: 9.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -20.0, y: 9.0), Coordinate(x: -2.0, y: 9.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 9.0)]), Polygon([Coordinate(x: 15.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -15.0), Coordinate(x: 2.0, y: -15.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 15.0, y: -2.0), Coordinate(x: 15.0, y: -12.0)]), ]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygon_MultiPolygon_interiorsIntersect_bothPolygons_withMultipleHoles() {

        let geometry1 = Polygon([Coordinate(x: -90.0, y: 20.0), Coordinate(x: -90.0, y: 60.0), Coordinate(x: 100.0, y: 60.0), Coordinate(x: 100.0, y: 20.0), Coordinate(x: -90.0, y: 20.0)], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -80.0, y: 0.0), Coordinate(x: -80.0, y: 80.0), Coordinate(x: 0.0, y: 80.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: -80.0, y: 0.0)], innerRings: [[Coordinate(x: -70.0, y: 30.0), Coordinate(x: -50.0, y: 30.0), Coordinate(x: -50.0, y: 50.0), Coordinate(x: -70.0, y: 50.0), Coordinate(x: -70.0, y: 30.0)], [Coordinate(x: -30.0, y: 10.0), Coordinate(x: -10.0, y: 10.0), Coordinate(x: -10.0, y: 70.0), Coordinate(x: -30.0, y: 70.0), Coordinate(x: -30.0, y: 10.0)]]), Polygon([Coordinate(x: 10.0, y: 80.0), Coordinate(x: 90.0, y: 80.0), Coordinate(x: 90.0, y: 0.0), Coordinate(x: 10.0, y: 0.0), Coordinate(x: 10.0, y: 80.0)], innerRings: [[Coordinate(x: 20.0, y: 10.0), Coordinate(x: 40.0, y: 10.0), Coordinate(x: 40.0, y: 70.0), Coordinate(x: 20.0, y: 70.0), Coordinate(x: 20.0, y: 1.0)], [Coordinate(x: 60.0, y: 30.0), Coordinate(x: 80.0, y: 30.0), Coordinate(x: 80.0, y: 50.0), Coordinate(x: 60.0, y: 50.0), Coordinate(x: 60.0, y: 30.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -10.0, y: 20.0), Coordinate(x: -10.0, y: 60.0), Coordinate(x: 0.0, y: 60.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: -10.0, y: 20.0)]), Polygon([Coordinate(x: -30.0, y: 60.0), Coordinate(x: -30.0, y: 20.0), Coordinate(x: -80.0, y: 20.0), Coordinate(x: -80.0, y: 60.0), Coordinate(x: -30.0, y: 60.0)], innerRings: [[Coordinate(x: -70.0, y: 30.0), Coordinate(x: -50.0, y: 30.0), Coordinate(x: -50.0, y: 50.0), Coordinate(x: -70.0, y: 50.0), Coordinate(x: -70.0, y: 30.0)]]), Polygon([Coordinate(x: 40.0, y: 20.0), Coordinate(x: 40.0, y: 60.0), Coordinate(x: 90.0, y: 60.0), Coordinate(x: 90.0, y: 20.0), Coordinate(x: 40.0, y: 20.0)], innerRings: [[Coordinate(x: 60.0, y: 30.0), Coordinate(x: 80.0, y: 30.0), Coordinate(x: 80.0, y: 50.0), Coordinate(x: 60.0, y: 50.0), Coordinate(x: 60.0, y: 30.0)]]), Polygon([Coordinate(x: 20.0, y: 60.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 10.0, y: 20.0), Coordinate(x: 10.0, y: 60.0), Coordinate(x: 20.0, y: 60.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    ///
    /// Polygon GeometryCollection tests
    ///

    func testPolygonGeometryCollection_emptyGeometryCollection_noIntersection() {

        let geometry1 = Polygon([Coordinate(x: -90.0, y: 20.0), Coordinate(x: -90.0, y: 60.0), Coordinate(x: 100.0, y: 60.0), Coordinate(x: 100.0, y: 20.0), Coordinate(x: -90.0, y: 20.0)])
        let geometry2 = GeometryCollection()
    ...
    func testPolygonGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
        let geometry2 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
    ...
    func testPolygonGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {
    ...
    func testPolygonGeometryCollection_geometryCollectionWithLineString_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygonGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 1.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygonGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 2.0, y: -3.0), Coordinate(x: 10.0, y: -12.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 2.0, y: -3.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygonGeometryCollection_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: 0.0, y: 0.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: 0.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 3.0, y: 0.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 0.0, y: -3.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 3.0, y: 0.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygonGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = Polygon([Coordinate(x: -30.0, y: 2.0), Coordinate(x: 30.0, y: 2.0), Coordinate(x: 30.0, y: -2.0), Coordinate(x: -30.0, y: -2.0), Coordinate(x: -30.0, y: 2.0)])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -3.0, y: 2.0), Coordinate(x: 3.0, y: 2.0), Coordinate(x: 3.0, y: -2.0), Coordinate(x: -3.0, y: -2.0), Coordinate(x: -3.0, y: 2.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testPolygonGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {

        let geometry1 = Polygon([Coordinate(x: -2.0, y: 2.0), Coordinate(x: 30.0, y: 2.0), Coordinate(x: 30.0, y: -2.0), Coordinate(x: -2.0, y: -2.0), Coordinate(x: -2.0, y: 2.0)])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 0.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 1.0, y: 0.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])]), Point(Coordinate(x: 5.0, y: 5.0)), MultiLineString([LineString([Coordinate(x: 3.0, y: -8.0), Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -2.0, y: 2.0))]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 1.0, y: 0.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 1.0, y: 0.0)])]))
    ...
    func testMultiPolygon_LineString_interiorsIntersect_firstPolygon() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: 4.0, y: 0.0), Coordinate(x: 0.0, y: 7.0), Coordinate(x: -5.0, y: 2.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LineString_interiorsIntersect_firstPolygon_withHole() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -8.0, y: 11.2), Coordinate(x: -5.0, y: 10.0)])]))
    ...
    func testMultiPolygon_LineString_interiorsIntersect_secondPolygon_withHole() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: 15.0, y: -15.0), Coordinate(x: 12.0, y: -18.0), Coordinate(x: 18.0, y: -18.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 14.0, y: -16.0), Coordinate(x: 12.0, y: -18.0), Coordinate(x: 18.0, y: -18.0)])]))
    ...
    func testMultiPolygon_LineString_interiorsIntersect_bothPolygons_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: -3.0, y: 10.0), Coordinate(x: 0.0, y: 13.0), Coordinate(x: 10.0, y: 13.0), Coordinate(x: 10.0, y: -18.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -3.0, y: 10.0), Coordinate(x: -2.0, y: 11.0)]), LineString([Coordinate(x: 10.0, y: -2.0), Coordinate(x: 10.0, y: -18.0)])]))
    ...
    func testMultiPolygon_LineString_interiorIntersectsInteriorAndBoundary_bothPolygons_atPointAndLineSegment_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LineString_interiorsIntersectAndBoundariesIntersect_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LineString_boundaryIntersectsInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LinearRing_interiorsIntersect_firstPolygon() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 4.0, y: 0.0), Coordinate(x: 0.0, y: 8.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 4.0, y: 0.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -2.0, y: 6.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -3.0, y: 3.0)])]))
    ...
    func testMultiPolygon_LinearRing_interiorsIntersect_firstPolygon_withHole() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: -10.0, y: 10.0), Coordinate(x: -10.0, y: 15.0), Coordinate(x: -5.0, y: 10.0), Coordinate(x: -10.0, y: 10.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LinearRing_interiorsIntersect_secondPolygon() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 0.0, y: 10.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: 10.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LinearRing_interiorsIntersect_secondPolygon_withHole() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 15.0, y: -15.0), Coordinate(x: 12.0, y: -18.0), Coordinate(x: 18.0, y: -18.0), Coordinate(x: 15.0, y: -15.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_LinearRing_interiorsIntersect_bothPolygons_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: -3.0, y: 10.0), Coordinate(x: 0.0, y: 13.0), Coordinate(x: 10.0, y: 13.0), Coordinate(x: 10.0, y: -18.0), Coordinate(x: -3.0, y: -18.0),  Coordinate(x: -3.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -2.0, y: 11.0), Coordinate(x: -3.0, y: 10.0), Coordinate(x: -3.0, y: 3.0)]), LineString([Coordinate(x: 10.0, y: -2.0), Coordinate(x: 10.0, y: -18.0), Coordinate(x: 2.0, y: -18.0)])]))
    ...
    func testMultiPolygon_LinearRing_interiorIntersectsMultiPolygonInteriorAndBoundary_bothPolygons_atPointAndLineSegment_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -12.0, y: -19.0), Coordinate(x: 1.0, y: -19.0), Coordinate(x: 3.0, y: -21.0), Coordinate(x: 19.0, y: -21.0), Coordinate(x: 21.0, y: -19.0), Coordinate(x: 21.0, y: -3.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 20.0, y: -2.0)), Point(Coordinate(x: 2.0, y: -20.0)), Point(Coordinate(x: 20.0, y: -20.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0)]), LineString([Coordinate(x: -20.0, y: 12.0), Coordinate(x: -16.0, y: 12.0)]), LineString([Coordinate(x: -12.0, y: 9.0), Coordinate(x: -12.0, y: 3.0)])]))
    ...
    func testMultiPolygon_LinearRing_interiorIntersectsMultiPolygonInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 9.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -3.0), Coordinate(x: 21.0, y: -3.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 20.0, y: -2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0)]), LineString([Coordinate(x: -20.0, y: 9.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 3.0)]), LineString([Coordinate(x: 20.0, y: -3.0), Coordinate(x: 2.0, y: -3.0)])]))
    ...
    func testMultiPolygon_MultiLineString_interiorsIntersect_bothPolygons_withHoles() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: -3.0, y: 10.0), Coordinate(x: -2.0, y: 11.0)]), LineString([Coordinate(x: 2.0, y: -10.0), Coordinate(x: 10.0, y: -18.0)])]))
    ...
    func testMultiPolygon_MultiLineString_interiorsIntersectAndBoundariesIntersect_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiLineString([LineString([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]), LineString([Coordinate(x: 100.0, y: 20.0), Coordinate(x: 150.0, y: 30.0), Coordinate(x: 200.0, y: 100.0)])], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_MultiLineString_boundaryIntersectsInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiLineString([LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)]), LineString([Coordinate(x: 100.0, y: 20.0), Coordinate(x: 150.0, y: 30.0), Coordinate(x: 200.0, y: 100.0)])], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_MultiLineString_boundaryIntersectsInteriorAndBoundaryAtAllFourBoundaryPoints_withHoles() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -20.0, y: 4.0)), Point(Coordinate(x: 6.0, y: -20.0)), Point(Coordinate(x: 20.0, y: -2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0)]), LineString([Coordinate(x: -20.0, y: 5.0), Coordinate(x: -18.0, y: 3.0)])]))
    ...
    func testMultiPolygon_Polygon_interiorsIntersect_firstPolygon() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 4.0, y: 0.0), Coordinate(x: -7.0, y: 0.0), Coordinate(x: 0.0, y: 7.0), Coordinate(x: 4.0, y: 0.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -4.0, y: 3.0), Coordinate(x: -2.0, y: 5.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -4.0, y: 3.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_Polygon_interiorsIntersect_firstPolygon_withHole() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: -10.0, y: 10.0), Coordinate(x: -10.0, y: 15.0), Coordinate(x: -5.0, y: 10.0), Coordinate(x: -10.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -8.0, y: 10.0), Coordinate(x: -8.0, y: 13.0), Coordinate(x: -5.0, y: 10.0), Coordinate(x: -8.0, y: 10.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_Polygon_interiorsIntersect_secondPolygon() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 0.0, y: 10.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 6.0, y: -4.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 4.0, y: -6.0), Coordinate(x: 6.0, y: -4.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_Polygon_interiorsIntersect_secondPolygon_withHole() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 15.0, y: -15.0), Coordinate(x: 18.0, y: -18.0), Coordinate(x: 12.0, y: -18.0), Coordinate(x: 15.0, y: -15.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 14.0, y: -16.0), Coordinate(x: 16.0, y: -16.0), Coordinate(x: 18.0, y: -18.0), Coordinate(x: 12.0, y: -18.0), Coordinate(x: 14.0, y: -16.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_Polygon_interiorsIntersect_bothPolygons_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: -3.0, y: 10.0), Coordinate(x: 0.0, y: 13.0), Coordinate(x: 10.0, y: 3.0), Coordinate(x: 10.0, y: -18.0), Coordinate(x: -3.0, y: -18.0), Coordinate(x: -3.0, y: 10.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: -3.0, y: 10.0), Coordinate(x: -2.0, y: 11.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: 10.0, y: -2.0), Coordinate(x: 10.0, y: -18.0), Coordinate(x: 2.0, y: -18.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 10.0, y: -2.0)])]))
    ...
    func testMultiPolygon_Polygon_polygonIntersectsMultiPolygonInteriorAndBoundary_bothPolygons_atPointLineSegmentAndPolygon_withHoles() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 10.0, y: 8.0), Coordinate(x: 8.0, y: 0.0), Coordinate(x: 8.0, y: -2.0), Coordinate(x: 4.0, y: -2.0), Coordinate(x: 4.0, y: 0.0), Coordinate(x: -12.0, y: -16.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: 10.0, y: 8.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 2.0, y: -2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 4.0, y: -2.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -12.0, y: 9.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 12.0), Coordinate(x: -20.0, y: 12.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -12.0, y: 3.0), Coordinate(x: -12.0, y: 9.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_Polygon_polygonIntersectsMultiPolygonInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: 14.0, y: -16.0), Coordinate(x: 12.0, y: -14.0), Coordinate(x: 12.0, y: 10.0), Coordinate(x: -2.0, y: 10.0), Coordinate(x: -2.0, y: 15.0), Coordinate(x: 16.0, y: 15.0), Coordinate(x: 16.0, y: -14.0), Coordinate(x: 14.0, y: -16.0)], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 14.0, y: -16.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -2.0, y: 10.0), Coordinate(x: -2.0, y: 15.0)]), LineString([Coordinate(x: 16.0, y: -12.0), Coordinate(x: 16.0, y: -14.0)]), LineString([Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -14.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -2.0), Coordinate(x: 16.0, y: -2.0), Coordinate(x: 16.0, y: -12.0)], precision: precision, coordinateSystem: cs)]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygon_Polygon_polygonSurroundsMultiPolygon() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = Polygon([Coordinate(x: -100.0, y: -100.0), Coordinate(x: -100.0, y: 100.0), Coordinate(x: 100.0, y: 100.0), Coordinate(x: 100.0, y: -100.0), Coordinate(x: -100.0, y: -100.0)], precision: precision, coordinateSystem: cs)
    ...
    func testMultiPolygon_MultiPolygon_interiorsIntersect_secondPolygons() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 13.0), Coordinate(x: -2.0, y: 13.0), Coordinate(x: -2.0, y: 3.0)]), Polygon([Coordinate(x: 8.0, y: -2.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -2.0)])], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: 10.0, y: 10.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 10.0, y: 30.0), Coordinate(x: 10.0, y: 10.0)]), Polygon([Coordinate(x: 0.0, y: 10.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: 10.0)])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: 4.0, y: -6.0), Coordinate(x: 6.0, y: -4.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 4.0, y: -6.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_MultiPolygon_interiorsIntersect_secondPolygons_withHoles_boundariesOverlapOnLineSegment() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: -8.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 8.0, y: -2.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 8.0, y: -2.0), Coordinate(x: 10.0, y: -2.0), Coordinate(x: 10.0, y: -10.0), Coordinate(x: 2.0, y: -10.0), Coordinate(x: 2.0, y: -8.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_MultiPolygon_interiorsIntersect_bothPolygons_withHoles_boundariesShareSegment() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: -8.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 8.0, y: -2.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -2.0, y: 5.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -5.0, y: 3.0), Coordinate(x: -5.0, y: 5.0), Coordinate(x: -2.0, y: 5.0)]), Polygon([Coordinate(x: 2.0, y: -8.0), Coordinate(x: 8.0, y: -8.0), Coordinate(x: 8.0, y: -2.0), Coordinate(x: 10.0, y: -2.0), Coordinate(x: 10.0, y: -10.0), Coordinate(x: 2.0, y: -10.0), Coordinate(x: 2.0, y: -8.0)])]))
    ...
    func testMultiPolygon_MultiPolygon_boundariesIntersectAtInteriorAndBoundary_bothPolygonsOfFirstPolygon_atPointLineSegmentAndPolygon() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 10.0, y: -2.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 2.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -12.0, y: 20.0), Coordinate(x: 21.0, y: 20.0), Coordinate(x: 21.0, y: -3.0)], innerRings: [[Coordinate(x: 10.0, y: 15.0), Coordinate(x: 10.0, y: 10.0), Coordinate(x: 15.0, y: 10.0), Coordinate(x: 15.0, y: 15.0), Coordinate(x: 10.0, y: 15.0)], [Coordinate(x: 2.0, y: 15.0), Coordinate(x: 4.0, y: 15.0), Coordinate(x: 4.0, y: 17.0), Coordinate(x: 2.0, y: 17.0), Coordinate(x: 2.0, y: 15.0)]]), Polygon([Coordinate(x: 110.0, y: 10.0), Coordinate(x: 110.0, y: 20.0), Coordinate(x: 120.0, y: 20.0), Coordinate(x: 120.0, y: 10.0), Coordinate(x: 110.0, y: 10.0)], innerRings: [[Coordinate(x: 118.0, y: 12.0), Coordinate(x: 118.0, y: 18.0), Coordinate(x: 112.0, y: 18.0), Coordinate(x: 112.0, y: 12.0), Coordinate(x: 118.0, y: 12.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: 20.0, y: -2.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 10.0, y: -2.0), Coordinate(x: 2.0, y: -2.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -8.0, y: 12.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -12.0, y: 16.0), Coordinate(x: -12.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 12.0), Coordinate(x: -8.0, y: 12.0)], precision: precision, coordinateSystem: cs)]))
    ...
    func testMultiPolygon_MultiPolygon_boundariesIntersectAtInteriorAndBoundary_withHoles() {
        ...
        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])], precision: precision, coordinateSystem: cs)
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -20.0, y: 3.0), Coordinate(x: 0.0, y: -17.0), Coordinate(x: 2.0, y: -17.0), Coordinate(x: 2.0, y: -25.0), Coordinate(x: -20.0, y: -25.0), Coordinate(x: -20.0, y: 3.0)], innerRings: [[Coordinate(x: -15.0, y: -15.0), Coordinate(x: -15.0, y: -20.0), Coordinate(x: -10.0, y: -20.0), Coordinate(x: -10.0, y: -15.0), Coordinate(x: -15.0, y: -15.0)]]), Polygon([Coordinate(x: 25.0, y: -15.0), Coordinate(x: -15.0, y: 25.0), Coordinate(x: 25.0, y: 25.0), Coordinate(x: 25.0, y: -15.0)], innerRings: [[Coordinate(x: 10.0, y: 10.0), Coordinate(x: 20.0, y: 10.0), Coordinate(x: 20.0, y: 20.0), Coordinate(x: 10.0, y: 20.0), Coordinate(x: 10.0, y: 10.0)]])], precision: precision, coordinateSystem: cs)
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -20.0, y: 3.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -17.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -10.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 12.0), Coordinate(x: -10.0, y: 20.0)]), Polygon([Coordinate(x: 12.0, y: -2.0), Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -10.0), Coordinate(x: 12.0, y: -2.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    ///
    /// MultiPolygon GeometryCollection tests
    ///

    func testMultiPolygonGeometryCollection_emptyGeometryCollection_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithPoint_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithLineString_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiLineString_noIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 2.0)]), LineString([Coordinate(x: 1.0, y: 10.0), Coordinate(x: 3.0, y: 10.0)])])])
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: 16.0, y: 2.0), Coordinate(x: 18.0, y: 6.0), Coordinate(x: 20.0, y: 2.0), Coordinate(x: 16.0, y: 2.0)])])])
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([Point(Coordinate(x: -2.5, y: 3.5))])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -2.5, y: 3.5))]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: -10.0, y: 6.0))])])
    ...
    func testMultiPolygonGeometryCollection_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: -2.0), Coordinate(x: 3.0, y: -3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([LinearRing([Coordinate(x: 0.0, y: 0.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 3.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: -2.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 3.0, y: -2.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([MultiLineString([LineString([Coordinate(x: -15.0, y: 25.0), Coordinate(x: -25.0, y: 15.0), Coordinate(x: -40.0, y: 15.0)]), LineString([Coordinate(x: 0.0, y: -20.0), Coordinate(x: 10.0, y: -20.0), Coordinate(x: 10.0, y: -40.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -20.0, y: 20.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: 2.0, y: -20.0), Coordinate(x: 10.0, y: -20.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([Polygon([Coordinate(x: -10.0, y: 10.0), Coordinate(x: 14.0, y: 10.0), Coordinate(x: 14.0, y: -14.0), Coordinate(x: -10.0, y: -14.0), Coordinate(x: -10.0, y: 10.0)])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPolygon([Polygon([Coordinate(x: -10.0, y: 9.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 10.0), Coordinate(x: -2.0, y: 10.0), Coordinate(x: -2.0, y: 3.0), Coordinate(x: -10.0, y: 3.0), Coordinate(x: -10.0, y: 9.0)]), Polygon([Coordinate(x: 14.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -14.0), Coordinate(x: 2.0, y: -14.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 14.0, y: -2.0), Coordinate(x: 14.0, y: -12.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        let geometry2 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -16.0, y: 2.0), Coordinate(x: -14.0, y: 3.0), Coordinate(x: -12.0, y: 2.0), Coordinate(x: -16.0, y: 2.0)])])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -14.0, y: 3.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -3.0, y: 3.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 2.0, y: -3.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 3.0, y: -2.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 2.0, y: -3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testMultiPolygonGeometryCollection_geometryCollectionWithMultipleGeometries_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: -8.0), Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: -5.0, y: 3.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -3.0, y: 3.0) ])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    ///
    /// GeometryCollection Point tests
    ///

    func testGeometryCollectionPoint_emptyGeometryCollection_noIntersection() {
    ...
    func testGeometryCollectionPoint_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionPoint_geometryCollectionWithLineString_noIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 3.0, y: 1.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithLinearRing_noIntersection() {

        let geometry1 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: 5.0), Coordinate(x: 5.0, y: 1.0), Coordinate(x: 1.0, y: 1.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiLineString_noIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 2.0)]), LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0)])])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithPolygon_noIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 0.0, y: 0.0))])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 1.0, y: 1.0))])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0), Coordinate(x: 1.0, y: 1.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: -1.0, y: 1.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: -1.0), Coordinate(x: -1.0, y: -1.0), Coordinate(x: -1.0, y: 1.0)])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -1.0, y: 1.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 1.0, y: -1.0), Coordinate(x: -1.0, y: -1.0), Coordinate(x: -1.0, y: 1.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionPoint_geometryCollectionWithMultipleGeometries_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 0.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 1.0, y: 0.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])]), Point(Coordinate(x: 5.0, y: 5.0)), MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])])
        let geometry2 = Point(Coordinate(x: 0.0, y: 0.0), precision: precision, coordinateSystem: cs)
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = GeometryCollection([LinearRing([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 1.0)])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = MultiPoint([Point(Coordinate(x: 9.0, y: -19.0)), Point(Coordinate(x: 2.5, y: 2.5)), Point(Coordinate(x: 6.0, y: -4.0)), Point(Coordinate(x: 13.0, y: 5.0)), Point(Coordinate(x: 3.0, y: -11.0)), Point(Coordinate(x: 10.0, y: -18.0)), Point(Coordinate(x: -9.0, y: 1.0))])
    ...
    func testGeometryCollectionMultiPoint_geometryCollectionWithMultipleGeometries_withIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 2.5, y: 20.0), Coordinate(x: 2.5, y: -20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -7.0, y: 10.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 10.0, y: -20.0), Coordinate(x: -34.0, y: -20.0), Coordinate(x: -34.0, y: 10.0), Coordinate(x: -7.0, y: 10.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 3.0, y: 20.0), Coordinate(x: 3.0, y: -20.0), Coordinate(x: -34.0, y: -20.0), Coordinate(x: -7.0, y: 10.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 10.0, y: 0.0), Coordinate(x: -2.0, y: 0.0), Coordinate(x: 0.0, y: -9.0), Coordinate(x: 4.0, y: -13.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: 0.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: -20.0), Coordinate(x: -20.0, y: -20.0), Coordinate(x: -20.0, y: 0.0), Coordinate(x: -40.0, y: 0.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: 0.0), Coordinate(x: 0.0, y: 20.0), Coordinate(x: 0.0, y: -20.0), Coordinate(x: -6.0, y: -20.0), Coordinate(x: -6.0, y: 20.0), Coordinate(x: -40.0, y: 20.0)])
    ...
    func testGeometryCollectionLineString_geometryCollectionWithMultipleGeometries_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 0.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 1.0, y: 0.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])]), Point(Coordinate(x: 5.0, y: 5.0)), MultiLineString([LineString([Coordinate(x: 3.0, y: -8.0), Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)])])])
        let geometry2 = LineString([Coordinate(x: 20.0, y: -18.0), Coordinate(x: 0.0, y: -18.0), Coordinate(x: -4.0, y: 0.0), Coordinate(x: -4.0, y: 20.0), Coordinate(x: -6.0, y: 20.0), Coordinate(x: -40.0, y: 20.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 19.0, y: -1.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 6.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 10.0, y: 8.0), Coordinate(x: 5.0, y: 20.0), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: 8.0, y: 9.0), Coordinate(x: 21.0, y: 0.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 2.5), Coordinate(x: 0.0, y: 2.5), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -9.0), Coordinate(x: 21.0, y: -9.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: 10.0, y: -18.0))])])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 2.5), Coordinate(x: 0.0, y: 2.5), Coordinate(x: -34.0, y: 20.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -18.0), Coordinate(x: 21.0, y: -18.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: 0.0)])])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 0.0), Coordinate(x: 3.0, y: 0.0), Coordinate(x: 3.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -18.0), Coordinate(x: 21.0, y: -18.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 5.0, y: -11.0), Coordinate(x: 10.0, y: -12.0)])])])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 1.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 0.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: -11.0), Coordinate(x: 21.0, y: -11.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithPolygon_withIntersection() {
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = LinearRing([Coordinate(x: 21.0, y: -3.0), Coordinate(x: 21.0, y: 1.0), Coordinate(x: 0.0, y: 1.0), Coordinate(x: 0.0, y: 12.0), Coordinate(x: -34.0, y: 12.0), Coordinate(x: -12.0, y: 12.0), Coordinate(x: -6.0, y: 9.0), Coordinate(x: -6.0, y: -11.0), Coordinate(x: 21.0, y: -11.0), Coordinate(x: 21.0, y: -3.0)])
    ...
    func testGeometryCollectionLinearRing_geometryCollectionWithMultipleGeometries_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithPoint_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithPoint_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiPoint_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithLineString_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiLineString_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithPolygon_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultiPolygon_withIntersection() {
    ...
    func testGeometryCollectionMultiLineString_geometryCollectionWithMultipleGeometries_withIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithPoint_noIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 1.0, y: 1.0))])
        let geometry2 = Polygon([Coordinate(x: -90.0, y: 20.0), Coordinate(x: -90.0, y: 60.0), Coordinate(x: 100.0, y: 60.0), Coordinate(x: 100.0, y: 20.0), Coordinate(x: -90.0, y: 20.0)])
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiLineString_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiPolygon_noIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: 2.5, y: 2.5))])
        let geometry2 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiPoint_withIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithLineString_withIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithLinearRing_withIntersection() {
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)]), LineString([Coordinate(x: 0.0, y: -11.0), Coordinate(x: 2.0, y: -3.0), Coordinate(x: 10.0, y: -12.0)])])])
        let geometry2 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: 0.0, y: 0.0), Coordinate(x: 6.0, y: 0.0), Coordinate(x: 6.0, y: -6.0), Coordinate(x: 0.0, y: -6.0), Coordinate(x: 0.0, y: 0.0)])])
        let geometry2 = Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)])
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])])])
        let geometry2 = Polygon([Coordinate(x: -30.0, y: 2.0), Coordinate(x: 30.0, y: 2.0), Coordinate(x: 30.0, y: -2.0), Coordinate(x: -30.0, y: -2.0), Coordinate(x: -30.0, y: 2.0)])
    ...
    func testGeometryCollectionPolygon_geometryCollectionWithMultipleGeometries_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 0.0), Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 1.0), Coordinate(x: 2.0, y: 0.0), Coordinate(x: 1.0, y: 0.0)]), Polygon([Coordinate(x: -6.0, y: 2.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -2.0, y: 2.0), Coordinate(x: -6.0, y: 2.0)])]), Point(Coordinate(x: 5.0, y: 5.0)), MultiLineString([LineString([Coordinate(x: 3.0, y: -8.0), Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)])])])
        let geometry2 = Polygon([Coordinate(x: -2.0, y: 2.0), Coordinate(x: 30.0, y: 2.0), Coordinate(x: 30.0, y: -2.0), Coordinate(x: -2.0, y: -2.0), Coordinate(x: -2.0, y: 2.0)])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithPoint_noIntersection() {
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiPoint_noIntersection() {
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithLineString_noIntersection() {
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithLinearRing_noIntersection() {
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiLineString_noIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 2.0, y: 2.0)]), LineString([Coordinate(x: 1.0, y: 10.0), Coordinate(x: 3.0, y: 10.0)])])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithPolygon_noIntersection() {
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiPolygon_noIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: 1.0, y: 3.0), Coordinate(x: 3.0, y: 5.0), Coordinate(x: 5.0, y: 3.0), Coordinate(x: 3.0, y: 1.0), Coordinate(x: 1.0, y: 3.0)]), Polygon([Coordinate(x: 16.0, y: 2.0), Coordinate(x: 18.0, y: 6.0), Coordinate(x: 20.0, y: 2.0), Coordinate(x: 16.0, y: 2.0)])])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithPoint_withIntersection() {

        let geometry1 = GeometryCollection([Point(Coordinate(x: -2.5, y: 3.5))])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiPoint_withIntersection() {

        let geometry1 = GeometryCollection([MultiPoint([Point(Coordinate(x: 0.0, y: 0.0)), Point(Coordinate(x: -10.0, y: 6.0))])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithLineString_withIntersection() {

        let geometry1 = GeometryCollection([LineString([Coordinate(x: 1.0, y: 1.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0)])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithLinearRing_withIntersection() {

        let geometry1 = GeometryCollection([LinearRing([Coordinate(x: 0.0, y: 0.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 3.0, y: 0.0), Coordinate(x: 0.0, y: 0.0)])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiLineString_withIntersection() {

        let geometry1 = GeometryCollection([MultiLineString([LineString([Coordinate(x: -15.0, y: 25.0), Coordinate(x: -25.0, y: 15.0), Coordinate(x: -40.0, y: 15.0)]), LineString([Coordinate(x: 0.0, y: -20.0), Coordinate(x: 10.0, y: -20.0), Coordinate(x: 10.0, y: -40.0)])])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithPolygon_withIntersection() {

        let geometry1 = GeometryCollection([Polygon([Coordinate(x: -10.0, y: 10.0), Coordinate(x: 14.0, y: 10.0), Coordinate(x: 14.0, y: -14.0), Coordinate(x: -10.0, y: -14.0), Coordinate(x: -10.0, y: 10.0)])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
    ...
    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultiPolygon_withIntersection() {

        let geometry1 = GeometryCollection([MultiPolygon([Polygon([Coordinate(x: -3.0, y: 3.0), Coordinate(x: 3.0, y: 3.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: -3.0, y: -3.0), Coordinate(x: -3.0, y: 3.0)]), Polygon([Coordinate(x: -16.0, y: 2.0), Coordinate(x: -14.0, y: 3.0), Coordinate(x: -12.0, y: 2.0), Coordinate(x: -16.0, y: 2.0)])])])
        let geometry2 = MultiPolygon([Polygon([Coordinate(x: -2.0, y: 3.0), Coordinate(x: -20.0, y: 3.0), Coordinate(x: -20.0, y: 20.0), Coordinate(x: -2.0, y: 20.0), Coordinate(x: -2.0, y: 3.0)], innerRings: [[Coordinate(x: -8.0, y: 9.0), Coordinate(x: -8.0, y: 16.0), Coordinate(x: -16.0, y: 16.0), Coordinate(x: -16.0, y: 9.0), Coordinate(x: -8.0, y: 9.0)]]), Polygon([Coordinate(x: 20.0, y: -2.0), Coordinate(x: 20.0, y: -20.0), Coordinate(x: 2.0, y: -20.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 20.0, y: -2.0)], innerRings: [[Coordinate(x: 16.0, y: -16.0), Coordinate(x: 16.0, y: -12.0), Coordinate(x: 12.0, y: -12.0), Coordinate(x: 12.0, y: -16.0), Coordinate(x: 16.0, y: -16.0)]])])
        ...
        var expected  = GeometryCollection()
        expected.append(MultiPoint([Point(Coordinate(x: -14.0, y: 3.0))]))
        expected.append(MultiLineString([LineString([Coordinate(x: -3.0, y: 3.0), Coordinate(x: -2.0, y: 3.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: 3.0, y: -2.0), Coordinate(x: 3.0, y: -3.0), Coordinate(x: 2.0, y: -3.0), Coordinate(x: 2.0, y: -2.0), Coordinate(x: 3.0, y: -2.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    func testGeometryCollectionMultiPolygon_geometryCollectionWithMultipleGeometries_withIntersection() {
        ...
        var expected  = GeometryCollection()
        expected.append(MultiLineString([LineString([Coordinate(x: 3.0, y: -8.0), Coordinate(x: 3.0, y: -18.0), Coordinate(x: 6.0, y: -18.0)])]))
        expected.append(MultiPolygon([Polygon([Coordinate(x: -5.0, y: 3.0), Coordinate(x: -4.0, y: 4.0), Coordinate(x: -3.0, y: 3.0), Coordinate(x: -5.0, y: 3.0)])]))

        XCTAssertEqual(resultGeometry, expected)
    }

    ///
    /// GeometryCollection GeometryCollection tests
    ///

    func testGeometryCollectionGeometryCollection_emptyGeometryCollections_noIntersection() {

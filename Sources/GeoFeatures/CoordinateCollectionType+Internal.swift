///
///  CoordinateCollectionType+Internal.swift
///
...
///
///  Created by Tony Stone on 12/18/18.
///
internal extension CoordinateCollectionType {
    ...
    internal func removeDuplicateLoops(_ linearRing: LinearRing) -> LinearRing {
        var loops = [Loop]()
    ...
    internal func slope(_ coordinate1: Coordinate, _ coordinate2: Coordinate) -> (Double, Bool) {
    ...
    internal func slope(_ segment: Segment) -> (Double, Bool) {

        return slope(segment.leftCoordinate, segment.rightCoordinate)
    }

    /// Returns true if the coordinate is on the line segment.
    private func coordinateIsOnLineSegment(_ coordinate: Coordinate, segment: Segment) -> LocationType {
    ...
    ///
    private func boundingBoxesOverlap1D(range1: (Double, Double), range2: (Double, Double)) -> Bool {
    ...
    ///
    private func boundingBoxesOverlap2D(segment: Segment, other: Segment) -> Bool {
    ...
    ///
    private func det2d(a: Double, b: Double, c: Double, d: Double) -> Double {
        return a*d - b*c
    }
    ...
    ///
    private func isLeft(p0: Coordinate, p1: Coordinate, p2: Coordinate) -> Double {
    ...
    ///
    internal func intersection(segment: Segment, other: Segment, firstCoordinateFirstSegmentBoundary: Bool = false, secondCoordinateFirstSegmentBoundary: Bool = false, firstCoordinateSecondSegmentBoundary: Bool = false, secondCoordinateSecondSegmentBoundary: Bool = false) -> LineSegmentIntersection {

...
///
///     ~/gyb --line-directive '' -DSelf=MultiPolygon -DElement=Polygon<CoordinateType> -DCoordinateSpecialized=true -o MultiPolygon.swift GeometryCollectionTypes.swift.gyb
///

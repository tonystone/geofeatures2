...
extension MultiLineString {
    ...
    /// that overlap at either a single point or a series of end segments into a single LineString.
    /// Note that (2) can be computationally complex and would generally take more than a single pass to combine
    /// the various LineStrings and intermediate LineStrings.  Therefore, we will only do part (1) for now.
    ///

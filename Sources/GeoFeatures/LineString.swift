...
public struct LineString<CoordinateType: Coordinate & CopyConstructable> {
    ...
    public init(precision: Precision = defaultPrecision, coordinateSystem: CoordinateSystem = defaultCoordinateSystem) {
        ...
        /// Note: No validation needed, an empty LineString is always valid.
    }
    ...
    ///
    public init(other: LineString<CoordinateType>) {

        self.coordinateSystem = other.coordinateSystem
        self.precision        = other.precision
        self.coordinates      = other.coordinates

        /// Note: No validation needed, an as it's assumed the `other` LineString is valid.
    }
    ...
    /// - seealso: `Precision`
    ///
    internal init(other: LineString<CoordinateType>, precision: Precision, coordinateSystem: CoordinateSystem) {
    ...
    ///
    /// Construct a `LineString` from a an `Array` of `CoordinateType`.
    ///
    /// - parameters:
    ...
    ///
    /// Construct a `LineString` from a any `Collection` type which holds `CoordinateType` objects.
    ///
...
extension LineString where CoordinateType: TupleConvertible {
    ...
    ///
    /// Construct a `LineString` from a any `Swift.Collection` type which holds `CoordinateType.TupleType` tuples.
    ///
    /// LineString can be constructed from any Swift.Collection type as

...
///
///     ~/gyb --line-directive '' -DSelf=GeometryCollection -DElement=Geometry -DCoordinateSpecialized=false -o GeometryCollection.swift GeometryCollectionTypes.swift.gyb
///
